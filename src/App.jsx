    ...
    return (
      <section id={id} className="scroll-mt-28 mb-6">
        <div className="bg-white/90 border border-gray-200 rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-300">
          <button
            className="w-full flex items-center justify-between gap-4 px-5 py-4 text-left bg-blue-50/20 rounded-2xl"
          ...
          >
            ...
            <ChevronDown
              className={"transition-transform text-blue-500 " + (isOpen ? "rotate-180" : "rotate-0")}
            />
          </button>
  ...
  return (
    <div className="bg-gray-50 min-h-screen text-gray-800">
        ...
        <div className="max-w-4xl mx-auto flex items-center justify-between px-4 sm:px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-sm px-3 py-1.5 rounded-full border border-gray-300 hover:bg-blue-50 transition"
      ...
      <main className="max-w-4xl mx-auto pt-28 pb-16 px-4 sm:px-6">
        {/* Header Card */}
        <div className="bg-white/90 border border-gray-200 rounded-2xl shadow-sm p-6 mb-6 hover:shadow-lg transition-shadow duration-300">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            <img
              src={profilePic}
              alt="Profile"
              className="w-28 h-28 rounded-full object-cover ring-4 ring-blue-500/30 hover:scale-105 hover:shadow-lg transition-transform duration-300"
            />
            <div className="flex-1 space-y-2">
              <h1 className="text-2xl font-bold text-blue-800">Panagiotis Gkantzos</h1>
            ...
            {[
              ...
              <li key={cert.short} className="flex items-center gap-2">
                ...
                <a
                  href={`/${cert.file}`}
                  download={cert.file}
                  className="inline-flex items-center gap-1 text-sm px-3 py-1 rounded-full border border-gray-300 hover:bg-blue-50 transition-transform transform hover:scale-105"
        ...
        <Section id="skills" title="Technical Skills">
          <div className="space-y-2">
            <div><strong className="text-blue-700">ServiceNow:</strong> ITSM, CSM, SPM, Application Development, UI/UX Customization</div>
            <div><strong className="text-blue-700">Programming:</strong> JavaScript, HTML5, CSS3, Python, SQL</div>
            <div><strong className="text-blue-700">Tools:</strong> Git, Jenkins, VS Code, Eclipse</div>
            <div><strong className="text-blue-700">Methodologies:</strong> Agile/Scrum, ITIL Framework</div>
          </div>
        </Section>
        ...
        <Section id="contact" title="Contact">
          <div className="space-y-2">
            <div>
              ...
              <a href="mailto:panosgaz3@gmail.com" className="underline text-gray-800 hover:text-blue-600">
                panosgaz3@gmail.com
              </a>
            </div>
